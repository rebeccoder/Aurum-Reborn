...
1. Navigate to the [GitHub repository](https://github.com/rebeccoder/Aurum-Reborn), and follow [these steps to clone the project](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository) into your IDE of choice.
